-- Script SQL para crear la base de datos MySQL
-- Ejecutar este script en MySQL antes de usar la aplicación

-- Crear la base de datos
CREATE DATABASE IF NOT EXISTS lab_05;
...
-- Insertar datos en la tabla PRERREQUISITO
INSERT INTO prerrequisito (curso_id, curso_req_id) VALUES
-- Prerrequisitos para Ingeniería de Sistemas
(3, 1),  -- POO requiere Intro a Programación
(4, 3),  -- Estructura de Datos requiere POO
(5, 4),  -- Base de Datos requiere Estructura de Datos
(6, 3),  -- Desarrollo Web requiere POO
(7, 5),  -- Ingeniería de Software requiere Base de Datos
(8, 4),  -- IA requiere Estructura de Datos
-- Prerrequisitos para Contabilidad
(14, 13), -- Contabilidad de Costos requiere Contabilidad Básica
(15, 14); -- Auditoría requiere Contabilidad de Costos
...
-- Secciones para el periodo 2025-1
...
-- Matrículas de estudiantes de primer semestre
...
-- Matrículas de estudiantes de segundo semestre
...
-- Matrículas de estudiantes de tercer semestre
...
-- Calificaciones de estudiantes que completaron cursos previos
...
UNION ALL
SELECT 'SECCIONES' as tabla, COUNT(*) as registros FROM seccion
UNION ALL
SELECT 'MATRICULAS' as tabla, COUNT(*) as registros FROM matricula
UNION ALL
SELECT 'PAGOS' as tabla, COUNT(*) as registros FROM pago
UNION ALL
SELECT 'CALIFICACIONES' as tabla, COUNT(*) as registros FROM calificacion;
